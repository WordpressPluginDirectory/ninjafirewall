...
function help_nfsubpolicies() {
	...
	get_current_screen()->add_help_tab( array(
		...
		<p><strong>' . __('Block user accounts deletion', 'ninjafirewall'). '</strong><br />' . __('Enabling this policy will block any attempt (e.g., exploiting a vulnerability, using a backdoor etc) to delete a user account.', 'ninjafirewall'). '</p>
