...
__('You must enter a source file. See help.', 'ninjafirewall');
__('Configuration successfully imported.', 'ninjafirewall');
__('You must enter a destination file. See help.', 'ninjafirewall');
__('Cannot create destination file "%s".', 'ninjafirewall');
__('Configuration saved to "%s".', 'ninjafirewall');
__('Enter your license: ', 'ninjafirewall');
__('Checking license...', 'ninjafirewall');
__('Import the firewall configuration.', 'ninjafirewall');
__('Export the firewall configuration.', 'ninjafirewall');
__('Enter your license at the prompt.', 'ninjafirewall');
__('GLOBAL PARAMETERS', 'ninjafirewall');
__('Path to the file to import or export the configuration.', 'ninjafirewall');
